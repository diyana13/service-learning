...
@section('content')
    <div class="col-lg-12">
        <div class="card card-maroon card-outline">
            ...
            <div class="card-body">
                <h6 class="card-title">Assessment Control Center</h6>

                <p class="card-text">Monitor project evaluations and manage group assessments.</p>
                <a href="{{ route('assessor.project-list') }}" class="btn btn-danger">Go to projects</a>
            </div>
        </div>
    </div>
    <!-- New Summary Section -->
