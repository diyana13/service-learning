    ...
    <div class="card card-warning card-outline">
        <div class="card-header">
            ...
            <div class="card-tools">
                <a href="{{ route('lecturer.show', $projectID) }}" class="btn btn-sm btn-danger"><i class="fa fa-angle-left"></i> Back</a>
            </div>
        </div>
        <div class="card-body">
        ...
        <form id="evaluate-form" action="{{ route('lecturer.store-evaluate', $group->id) }}" method="POST">
            @csrf
